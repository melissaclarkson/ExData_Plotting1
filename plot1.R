# plot 1 for Course project 1, Exploratory data analysis
...
hist(twoDayData$Global_active_power, col="red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power")
